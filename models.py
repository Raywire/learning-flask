...
class Place(object):
  ...
  def query(self, address):
    ...
    response = requests.get('https://en.wikipedia.org/w/api.php?action=query&list=geosearch&gsradius=10000&gscoord=37.786971%7C-122.399677&gslimit=20&format=json')
